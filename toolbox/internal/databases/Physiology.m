...
%                tf = logical(height(subset(obj.db.(nm), varargin{:})));
        ...
        %
            ...
            if isscalar(obj)
                ...
                if ~irec
                   error('PBPK:Physiology:aliasrecord:noEntriesFound', ...
            ...
            if isscalar(obj)
                ...
                if obj(1).pertissue.(nm)  % expect varargin of length 2
                    ...
                    if ~all(liVarargin)
                        ...
                        error('PBPK:Physiology:updaterecord:noEntriesFound', ...
        ...
        function str = obj2str(obj, context)
            switch context
                case {'array','table'}
                   ...
                   str = strjoin(cl,'\t');
                otherwise
                    error('PBPK:Physiology:obj2str:unknownContext', ...
