%MAB_PBPK_11CMT_EXTRAVASLIM_INT_MM Extravas.-lim. mAb PBPK model with MM elimination
...
%    - Vmax (Mass/Time) 
%         Michaelis-Menten parameter; maximum elimination rate in 
%         Michaelis-Menten term.
%    - Km (Mass/Volume)
%         Michaelis-Menten parameter; concentration achieving half-maximal 
%         elimination rate.
%
...
% General structure
% ========================================================================%
function model = mAb_PBPK_11CMT_extravasLim_int_MM()
...
%OBSFUN Observables in 11 CMT extravasation-limited model with MM clearance
