%SMD_ALLOMETRIC_LUMPEDPBPK_WELLSTIRRED Allometrically scaled lumped PBPK
...
%    This function allometrically scales a lumped PBPK model from a
%    reference individual to a target individual. The underlying PBPK model
%    is for sMD based on well-stirred tissue distribution and 
%    hepatic clearance.
%
...
%                             the 13 physiological compartments)
%    - targetBW               a Mass-type DimVar: the body weight to which
%                             to scale allometrically.
%    - forceEmpiricalAbsorptionModel  
%                             a Boolean; if true, throws an error if 
%                             DrugData-parameter 'lambda_po' is undefined 
%                             (default: false)

% ========================================================================%
% General structure
% ========================================================================%
function model = sMD_allometric_lumpedPBPK_wellstirred()
...
%INITFUN Initialize allometrically scaled lumped 12cmt PBPK model
    ...
    % allometric scaling of lumped parameters:
    BW_ref = queryphys('BW');
...
%RHSFUN ODE system of allometrically scaled lumped 12cmt PBPK model
...
%OBSFUN Observables in allometrically scaled lumped 12-CMT PBPK model
